...
# Create *strings.locale* files instead of *strings.xml* within your Titanium projects. We used _locale_ as extension, because of some UTF-8 problems. Simple tread them as they were Java properties.
